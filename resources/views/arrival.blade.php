                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="" style="font-family: 'Poppins', sans-serif;">
                            ...
                            <div class="row align-items-center p-3">
                                <div class="col">
                                    <h3 class="text-uppercase">Arrival (ARR) Message</h3>
                                    <div class="row mb-2">
                                        @if(count($errors) > 0)
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-1 me-4 fw-bold">
                                            <label for="arr-id" class="me-2 mb-0 col-form-label text-primary">{{ __('ARR ID') }}</label>
                                            <input name="arr-id" id="arr-id" class="p-2 rounded form-control">
                                        </div>
                                        <div class="col-1 me-4 fw-bold">
                                            <label for="arr_time" class="me-2 mb-0 col-form-label text-primary">{{ __('TIME') }}</label>
                                            <input name="arr_time" id="arr_time" class="p-2 rounded form-control">
                                        </div>
                                    </div>
                                    {{-- <hr class="text-secondary border-1"> --}}
                                    <div class="row mb-3">
                                        <div class="col-8 me-4 fw-bold">
                                            <label for="arrival-aerodrome" class="me-2 mb-0 col-form-label text-primary">{{ __('ARRIVAL AERODROME') }}</label>
                                            <textarea class="form-control" id="arrival-aerodrome" name="arrival-aerodrome" style="height: 100px;"></textarea>
                                        </div>
                                    </div>
                                    {{-- <hr class="text-secondary border-1"> --}}
                                    <div class="row mb-3">
