        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card border-0 shadow p-3" style="border-radius: 13px;">
                    <h3 class="fw-bold">CNL Messages</h3>
                        ...
                        <table id="yajra-datatable" class="table yajra-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>{{$d->dof}}</th>
                                    <th>
                                        {{-- <a href="/cnl-message-detail/{{$d->id}}" class="btn btn-dark text-white">
                                            {{ __('Detail') }}
                                        </a> --}}
                                        <a href="/cnl-message-detail/{{$d->id}}" class="btn btn-secondary text-white"><i class="bi bi-search"></i></a>
                                    </th>
                                </tr>
                                @endforeach
