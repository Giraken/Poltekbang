                            ...
                            <div class="col">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3 d-inline-flex align-items-center me-4">
                                        <label for="filling-time" class="fw-bold me-2 mb-0 col-form-label" style="">{{ __('FILLING TIME:') }}</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-3 me-4 fw-bold">
                                        <label for="filled-by" class="me-2 mb-0 col-form-label text-primary">{{ __('FILLED BY') }}</label>
